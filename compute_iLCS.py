...
attracting_ilcs = plt.contour(x,y,s1_directional_derivative,levels=[0],colors='blue')
repelling_ilcs = plt.contour(x,y,s2_directional_derivative,levels=[0],colors='red')
